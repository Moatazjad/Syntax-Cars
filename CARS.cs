...
namespace Syntax_Cars
{
    public class CARS
    {
        ...
        public CARS(string Type, string ID, string Brand, string Model, int price)
        {
            _type = Type;
            _ID = ID;
            _Brand = Brand;
    ...
    public class Sedan : CARS
    {
        ...
        public Sedan(string Type, string ID, string Brand, string Model, int Price, bool Fuel, bool Diesel, int TrunkCapacity) : base(Type, ID, Brand, Model, Price)
        {
            _Fuel = Fuel;
            _Diesel = Diesel;
    ...
    public class Hybrid : CARS
    {
        ...
        public Hybrid(string Type, string ID, string Brand, string Model, int Price, int BatteryRange, int ChargingTime, bool RoofWindow) : base(Type, ID, Brand, Model, Price)
        {
    ...
    public class Sport : CARS
    {
        ...
        public Sport(string Type, string ID, string Brand, string Model, int Price, int Acceleration, int TopSpeed, string EngineSpecs) : base(Type, ID, Brand, Model, Price)
        {
